...
- Клиент при запуске имеет один обязательный аргумент - <pid> хоста
- Команды для ввода:
    - `/exit` - завершить работу
    - `/w <id> <message>` - отправить личное сообщение клиенту с указанным id
    - `/b <message>` - отправить общее сообщение
...
- Клиенты разделены по типу соединения, но хост один - он умеет обрабатывать любой тип соединения
